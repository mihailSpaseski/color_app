...
const InputField: React.FC<IProps> = ({nameColor, setNameColor}) => {
    ...
    const handleClick = async (e: any) => {
        ...
        if (!input.name ) return ( alert('Input field cannot be empty') ) 
